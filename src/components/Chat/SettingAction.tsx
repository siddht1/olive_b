      ...
      <Switch>
        <Match when={actionState.showSetting === "global"}>
          <div class="<sm:max-h-10em max-h-14em overflow-y-auto">
            ...
            <SettingItem icon="i-carbon:keyboard" label="Enter key to send message">
              <SwitchButton
        ...
        <Match when={actionState.showSetting === "session"}>
          <div class="<sm:max-h-10em max-h-14em overflow-y-auto">
            ...
            <SettingItem icon="i-carbon:data-enrichment" label="Thinking divergence">
            ...
            <SettingItem icon="i-carbon:save-image" label="record the conversation">
              <SwitchButton
            ...
            <SettingItem
              ...
              label="Start a continuous conversation"
            >
              <SwitchButton
          ...
          fallback={
            <div class="flex">
              ...
              <ActionItem
                ...
                label={actionState.clearSessionConfirm ? "OK" : "Clear dialog"}
              />
            </div>
          }
        >
            ...
            <div class="flex">
              ...
              <Show when={store.sessionId !== "index"}>
                ...
                <ActionItem
                  ...
                  label={actionState.deleteSessionConfirm ? "OK" : "Delete conversation"}
                />
              </Show>
            </div>
          </Match>
